...
class Shin_ChaingunGuy : ShinDoom_Actor Replaces ChaingunGuy
{
	...
	{
		invoker.sprite = invoker.BaseSpriteCG;
	}
	
	SpriteID BaseSpriteCG;
	...
	override void PostBeginPlay()
	{
		...
		{
			BaseSpriteCG = GetSpriteIndex('CPS2');
		}
		else
		{
			BaseSpriteCG = GetSpriteIndex('CPOS');
		}
	...
	See:
		...
		Loop;
	Missile:
		CPOS H 0 A_Jumpif((BaseSpriteCG == GetSpriteIndex('CPS2')), "Missile.D1");
	...
	Pain:
		...
		Goto See;
	Death:
		CPOS H 0 A_Jumpif((BaseSpriteCG == GetSpriteIndex('CPS2')), "Death.D1");
		CPOS H 5;
		CPOS I 5 A_Scream;
	...
	Death.D1:
		...
		Stop;
	XDeath:
		CPOS H 0 A_Jumpif((BaseSpriteCG== GetSpriteIndex('CPS2')), "XDeath.D1");
		CPOS O 5;
		CPOS P 5 A_XScream;
...
class Shin_WolfensteinSS : ShinDoom_Actor
{
	Default
	{
		Health 50;
